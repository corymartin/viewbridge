 ...
 *    - views:     Views to create functions for. Array or `*` for all.
...
Viewbridge.prototype = {
  ...
  _setConfig: function(config) {
    ...
    this.config.engine    = ENGINES[config.engine.toLowerCase()];
...
, _mapViews: function() {
    ...
    this.config.views = this.config.views.map(function(view) {
      ...
      view = view.trim();
      view = Array.prototype.map.call(view, function(ch) {
